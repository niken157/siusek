       ...
       <hr class="border border-dark opacity-75">
        <p>
            ...
            <div class="input-group mb-3">
                <input type="text" class="form-control" name="hari" placeholder="Masukkan Hari" aria-label="Recipient's username" aria-describedby="basic-addon2" required>
            </div>
               Tanggal
               <div class="input-group mb-3">
                <input type="date" class="form-control" name="tanggal" aria-label="Recipient's username" aria-describedby="basic-addon2" required>
              </div>
              <br>

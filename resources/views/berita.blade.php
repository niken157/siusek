                    ...
                    @foreach($ujian as $p)
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-outline-danger" onclick="return confirm('Apakah Anda Yakin Menghapus Berita Acara Digital Ini?')" title="Hapus Riwayat Berita Acara " href="/berita/hapus_digital/{{ $p->nomer_ruangan }}/{{ $p->no_sesi }}" role="button"><i class="fas fa-fw fa-trash"> </i>Hapus</a>
                                @endif

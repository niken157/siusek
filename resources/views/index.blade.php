    ...
    <div class="row">
        <div class="col-xl-3 col-md-6">
            <div class="card bg-primary text-white mb-4">
                <div class="card-body">Data Peserta Didik <span style="float: right"> <p>{{$peserta->count()}}</p></div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-warning text-white mb-4">
                <div class="card-body">Data Ruangan <span style="float: right"> <p>{{$ruangan->count()}}</div>
                <div class="card-footer d-flex align-items-center justify-content-between">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-success text-white mb-4">
                <div class="card-body">Data Sesi <span style="float: right"> <p>{{$sesi->count()}}</div>
                <div class="card-footer d-flex align-items-center justify-content-between">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-danger text-white mb-4">
                <div class="card-body">Data Pembagian Kartu <span style="float: right"> <p>{{$uji->count()}}</div>
                <div class="card-footer d-flex align-items-center justify-content-between">
